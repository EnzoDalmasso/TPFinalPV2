...
public class PersistenceManager : MonoBehaviour
{
    ...
    public string GetSring(string key, string defaultValue = "")
    {
    ...
    public void SaveVolumenConfig(float volumen)
    {
        SetFloat(keyVolume, volumen);
        Debug.Log(" Volumen Escogido"+  volumen);
    }
